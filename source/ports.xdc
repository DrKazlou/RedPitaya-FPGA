...
# ADC data flat (channel A only)
set_property IOSTANDARD LVCMOS18 [get_ports adc_dat_i_flat[*]]
set_property IOB TRUE [get_ports adc_dat_i_flat[*]]

# Channel 0 (bits 6:0)
set_property PACKAGE_PIN Y17 [get_ports adc_dat_i_flat[0]]
set_property PACKAGE_PIN Y16 [get_ports adc_dat_i_flat[1]]
set_property PACKAGE_PIN W14 [get_ports adc_dat_i_flat[2]]
set_property PACKAGE_PIN Y14 [get_ports adc_dat_i_flat[3]]
set_property PACKAGE_PIN V12 [get_ports adc_dat_i_flat[4]]
set_property PACKAGE_PIN W13 [get_ports adc_dat_i_flat[5]]
set_property PACKAGE_PIN V13 [get_ports adc_dat_i_flat[6]]

# Channel 1 (bits 13:7)
set_property PACKAGE_PIN W15 [get_ports adc_dat_i_flat[7]]
set_property PACKAGE_PIN W16 [get_ports adc_dat_i_flat[8]]
set_property PACKAGE_PIN V15 [get_ports adc_dat_i_flat[9]]
set_property PACKAGE_PIN V16 [get_ports adc_dat_i_flat[10]]
set_property PACKAGE_PIN Y19 [get_ports adc_dat_i_flat[11]]
set_property PACKAGE_PIN W18 [get_ports adc_dat_i_flat[12]]
set_property PACKAGE_PIN Y18 [get_ports adc_dat_i_flat[13]]

# Channel 2 (bits 20:14)
set_property PACKAGE_PIN W20 [get_ports adc_dat_i_flat[14]]
set_property PACKAGE_PIN W19 [get_ports adc_dat_i_flat[15]]
set_property PACKAGE_PIN V17 [get_ports adc_dat_i_flat[16]]
set_property PACKAGE_PIN V18 [get_ports adc_dat_i_flat[17]]
set_property PACKAGE_PIN U17 [get_ports adc_dat_i_flat[18]]
set_property PACKAGE_PIN T16 [get_ports adc_dat_i_flat[19]]
set_property PACKAGE_PIN T17 [get_ports adc_dat_i_flat[20]]

# Channel 3 (bits 27:21)
set_property PACKAGE_PIN R19 [get_ports adc_dat_i_flat[21]]
set_property PACKAGE_PIN R17 [get_ports adc_dat_i_flat[22]]
set_property PACKAGE_PIN T15 [get_ports adc_dat_i_flat[23]]
set_property PACKAGE_PIN R16 [get_ports adc_dat_i_flat[24]]
set_property PACKAGE_PIN T20 [get_ports adc_dat_i_flat[25]]
set_property PACKAGE_PIN U20 [get_ports adc_dat_i_flat[26]]
set_property PACKAGE_PIN V20 [get_ports adc_dat_i_flat[27]]

# ADC clocks flat
set_property IOSTANDARD DIFF_HSTL_I_18 [get_ports adc_clk_i_flat[*]]
set_property PACKAGE_PIN U18 [get_ports adc_clk_i_flat[1]]  
set_property PACKAGE_PIN U19 [get_ports adc_clk_i_flat[0]]  
set_property PACKAGE_PIN N20 [get_ports adc_clk_i_flat[3]]  
set_property PACKAGE_PIN P20 [get_ports adc_clk_i_flat[2]]  
...
create_clock -period 8.000 -name adc_clk_01 [get_ports {adc_clk_i_flat[1]}]
create_clock -period 8.000 -name adc_clk_23 [get_ports {adc_clk_i_flat[3]}]

# 2. Input Delays (Source Synchronous Data)
# The ADC sends data edge-aligned with the clock. We need to tell the FPGA this.
# A standard 125MHz DDR interface usually requires constraints telling the tool
# the data becomes valid/invalid relative to the clock edges.
# These values (3.4ns / -3.4ns) define the valid window.
set_input_delay -clock adc_clk_01 -max 3.400 [get_ports {adc_dat_i_flat[*]}]
set_input_delay -clock adc_clk_01 -min -3.400 [get_ports {adc_dat_i_flat[*]}]
set_input_delay -clock adc_clk_01 -max 3.400 [get_ports {adc_dat_i_flat[*]}] -clock_fall -add_delay
set_input_delay -clock adc_clk_01 -min -3.400 [get_ports {adc_dat_i_flat[*]}] -clock_fall -add_delay

set_input_delay -clock adc_clk_23 -max 3.400 [get_ports {adc_dat_i_flat[*]}]
set_input_delay -clock adc_clk_23 -min -3.400 [get_ports {adc_dat_i_flat[*]}]
set_input_delay -clock adc_clk_23 -max 3.400 [get_ports {adc_dat_i_flat[*]}] -clock_fall -add_delay
set_input_delay -clock adc_clk_23 -min -3.400 [get_ports {adc_dat_i_flat[*]}] -clock_fall -add_delay

# 3. Clock Domain Crossing (CDC) False Paths
# You manually synchronize Ch2/3 data from adc_clk_23 to adc_clk_01 in Verilog
# (using adc_dat_sync1_ch2, etc.). You must tell Vivado NOT to time this path,
# or it will try to fix the skew between two independent ADC clocks and fail.
